...
ALTER TABLE dispositivos_cluster
    ...
    ADD COLUMN IF NOT EXISTS transport VARCHAR(30) NULL AFTER firmware_version,
    ...
    ADD COLUMN IF NOT EXISTS health VARCHAR(30) NOT NULL DEFAULT 'unknown' AFTER gateway_device_id,
