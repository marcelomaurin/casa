...
<head>
  ...
  <link rel="stylesheet" href="/casa/lcars-framework.css?v=1.1.0">
  <link rel="stylesheet" href="/casa/lcars-site.css?v=1.1.0">
</head>
<body>
  ...
  <script src="/casa/lcars-framework.js?v=1.1.0"></script>
  <script src="/casa/lcars-site.js?v=1.1.0"></script>
</body>
</html>
