...
<head>
  ...
  <link rel="stylesheet" href="/casa/lcars-site.css?v=1.4.0">
</head>
<body>
  <div class="ja-site-tools" aria-label="Ferramentas do sistema">
    ...
    <button type="button" onclick="CASASite.changePassword()">ALTERAR SENHA</button>
  ...
  <script src="/casa/lcars-site.js?v=1.4.0"></script>
</body>
</html>
